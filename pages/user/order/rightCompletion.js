...
Page({
    ...
    onReady: function(e) {
        var that = this;
        common.post('app.php?c=rights&a=detail&pigcms_id=' + this.data.id + '&order_no=' + this.data.order_no + '&id=' + this.data.returnid, '', "returnData", that);
    },
    ...
    returnData: function(result) {
        ...
        if (result.err_code == 0) {
            ...
            console.log(this.data.returnData.rights);
