 ...
 * 获取省份，以及当前选中项
 * param that obj
 * param province_code 选择的省份code 例：340000
 */
picker.province = function(that, province_code) {
    var i = 0;
    var code = [];
    var name = [];
    ...
    that.setData({
        province_name_arr: name,
        province_code_arr: code,
 ...
 * 获取省份下的城市，以及当前选中项
 * param that obj
 * param province_code 选择中省份code 例：340000
 * param city_code 选中的城市code 例：340100
 */
picker.city = function(that, province_code, city_code) {
    var i = 0;
    var code = [];
    var name = [];
    var city_index = 0;
    for (var key in area) {
        if (province_code == area[key][1]) {
            code[i] = key;
            name[i] = area[key][0];
 ...
 * 获取城市下的地区，以及当前选中项
 * param that obj
 * param city_code 选择中省份code 例：340000
 * param country_code 选中的城市code 例：340100
 */
picker.country = function(that, city_code, country_code) {
    var i = 0;
    var code = [];
    var name = [];
    var country_index = 0;
    for (var key in area) {
        if (city_code == area[key][1]) {
            code[i] = key;
            name[i] = area[key][0];
    ...
    that.setData({
        country_name_arr: name,
        country_code_arr: code,
        country_index: country_index
    });
};


module.exports = { area: area, picker: picker };
